...
<form:form modelAttribute="searchCriteria" action="${actionUrl}">
	...
	<fieldset> 
		...
		<input type="submit" class="button" name="_eventId_search" value="Find apartmans" />
    </fieldset>
</form:form>

<h2>Current Apartman Bookings</h2>
<table class="summary">
	<thead>
		<tr>
			<th>Name</th>
	...
	<tbody>
		<c:forEach var="booking" items="${bookings}">
			<tr>
				<td>${booking.apartman.name}</td>
				<td>${booking.apartman.address}</td>
				<td>${booking.apartman.city}, ${booking.apartman.state}</td>
